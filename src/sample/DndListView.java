...
//		System.out.println("handleTargetDragEntered");
	...
	public void handleTargetDragDropped(DragEvent event) {
        ...
        boolean success = false;
            System.out.println(dragboard.hasFiles());
...
//
//                FXMLController.dndList.getItems().add(f.getPath());
//            }
        }
        else{
	...
	private void autoscroll(DndListCell<T> dropTagetCell) {
		try {
			DndListView<T> list = (DndListView<T>) dropTagetCell.getOwnerList();
